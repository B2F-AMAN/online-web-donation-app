...
{
	$loginid 	= "onlinecharity@rbi-newdelhi.in";
	$password 	= "QrLF3#ErAW3R";
	$smtpserver = "mail.rbi-newdelhi.in";
	$smtpport 	= 587;
	$mailsender = $_SESSION['project_title'];
	$companyname= $_SESSION['project_title'];
	$facebook = "https://www.facebook.com/OnlineCharity";
	$twitter = "https://www.twitter.com/OnlineCharity";
	$youtube = "https://www.youtube.com/OnlineCharity";
	$linkedin = "https://www.linkedin.com/OnlineCharity";
	$companyaddress  = $_SESSION['project_title'] . ", 9-57, Wadi-e-Hadees, Hyderabad-500005, India | Email us: OnlineCharity@gmail.com";
	$contactno = "+91-9550313048";
	$url = "www.OnlineCharity.in";
...
//sendmail("studentprojects.live@gmail.com", "Shiva prasad" , "My subject title", "My message");
?>