...
if ($("#staff_type").val() == "") {
  $("#errstaff_type").html("Kindly select Staff Type..");
  i = 1;
}

if ($("#staff_name").val() == "") {
  $("#errstaff_name").html("Staff Name should not be empty..");
  i = 1;
}

if ($("#login_id").val() == "") {
  $("#errlogin_id").html("Login ID should not be empty..");
  i = 1;
}
...
if ($("#confirmpassword").val() == "") {
  $("#errconfirmpassword").html("Confirm Password should not be empty..");
  i = 1;
}

if ($("#status").val() == "") {
  $("#errstatus").html("Kindly select the status..");
  i = 1;
}
